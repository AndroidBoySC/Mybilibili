...
public class CBPageChangeListener implements ViewPager.OnPageChangeListener {
    ...
    public CBPageChangeListener(ArrayList<ImageView> pointViews,int page_indicatorId[], PageSelected pageSelected){
    ...
    public void onPageSelected(int index) {
        ...
        if(pageSelected != null) {
            pageSelected.onPageSelected(index);
        }
    }

    interface PageSelected{
        void onPageSelected(int intdex);
    }
}
