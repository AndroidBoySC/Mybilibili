...
public class CityUtil {
    ...
    public static List<City> getCityList() {
        ...
        final String NEIMENG = "内蒙古";
        dataList.add(new City("赤峰", NEIMENG));
        dataList.add(new City("包头", NEIMENG));
        dataList.add(new City("乌海", NEIMENG));
        dataList.add(new City("呼和浩特", NEIMENG));
        dataList.add(new City("二连浩特", NEIMENG));
        dataList.add(new City("北京", NEIMENG));
        dataList.add(new City("天津", NEIMENG));
        dataList.add(new City("重庆", NEIMENG));
        dataList.add(new City("成都", NEIMENG));
        dataList.add(new City("哈尔滨", NEIMENG));
        return dataList;
    }
}
