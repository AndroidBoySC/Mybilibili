...
public class MySearchView extends LinearLayout{
    ...
    //搜索框组件
    private EditText et_search;//搜索按钮
    private TextView tv_clear;//删除搜索记录按钮
    ...
    //数据库变量，用于存放历史搜索记录
    private MySaveDatabaseHelper helper;
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        //搜索框字体颜色
        textColorSearch = typedArray.getColor(R.styleable.Search_View_textColorSearch,context.getResources().getColor(R.color.white));
        //搜索框提示内容
        ...
        //搜索框颜色
        searchBlockColor = typedArray.getColor(R.styleable.Search_View_searchBlockColor,context.getResources().getColor(R.color.colorText));
        //释放资源
        typedArray.recycle();
    ...
    private void init() {
        ...
        helper = new MySaveDatabaseHelper(mContext,"QiuShi.db",null,5);
        ...
        et_search.setOnKeyListener(new View.OnKeyListener() {
            public boolean onKey(View v, int keyCode, KeyEvent event) {
                if (keyCode == KeyEvent.KEYCODE_ENTER && event.getAction() == KeyEvent.ACTION_DOWN) {
                    ...
                    Toast.makeText(mContext, "需要搜索的是" + et_search.getText(), Toast.LENGTH_SHORT).show();
...
//                Toast.makeText(context, "返回到上一页", Toast.LENGTH_SHORT).show();
    ...
    private boolean hasData(String tempName) {
        // 从数据库中Search表里找到name=tempName的id
        Cursor cursor = helper.getReadableDatabase().rawQuery(
     ...
     * 点击键盘中搜索键后的操作，用于接口回调
     */
    public void setOnClickSearch(ClickCallBack mCallBack){
